...
clipInit=function (){
	...
	var str="";
	str+="<ul>";
	str+="<a class='disbled' id='firstPage' onclick='FirstPage()'>首页</a>";
	str+="<a class='disbled' id='lastPage' onclick='LastPage()' >上一页</a>";
	...
	str+="</div>";
	str+="<a class='BORDER' id='nextPage' onclick='NextPage()' href='?pageNo=${page.number + 1 + 1 }'>下一页</a>";
	str+="<a class='BORDER' id='endPage' onclick='EndPage()' style='border-right:1px solid #ccc'>尾页</a>";
	str+="<li class='clear'></li>";
	str+="</ul>";
	$("#clipDIV").html(str);
