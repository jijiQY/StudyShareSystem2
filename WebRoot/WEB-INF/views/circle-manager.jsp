...
<!--_header 作为公共模版分离出去-->
			...
			<div class="container-fluid cl">
				...
				<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
					<ul class="cl">
						...
						<li class="dropDown dropDown_hover">
							<a href="#" class="dropDown_A" onclick="exit()">退出 <i class="Hui-iconfont">&#xe6a6;</i></a>
	...
	<aside class="Hui-aside">
		...
		<div class="menu_dropdown bk_2">
			...
			<dl id="menu-product">
				...
				<dd>
					<ul>
						<li>
							<a href="userMessageManager" 用户信息管理 ">用户信息管理</a></li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu-admin ">
			...
			<dd >
				<ul>
					<li><a href="circleManager " title="分享圈管理 ">分享圈管理</a></li>
...
<section class="Hui-article-box ">
			<nav class="breadcrumb "><i class="Hui-iconfont ">&#xe67f;</i> 首页 <span class="c-gray en ">&gt;</span> 分享圈管理
			...
			<div class="mt-20 ">
				...
				<table class="table table-border table-bordered table-hover table-bg table-sort ">
					...
					<tbody>
						<c:forEach items="${page.content }" var="circleManager">
				<tr class="text-c">
					<td >${circleManager.id }</td>
					<td >${circleManager.circleName }</td>
					<td >${circleManager.level }</td>
					<td >${circleManager.superior_circle_id }</td>
					
					<td>
					<button class="btn radius btn-primary size-S" onclick="lookover('${circleManager.id }')">查看</button>
								<button class="btn radius btn-primary size-S" onclick="del('${circleManager.id }')">删除</button>
					</td>
				</tr>
			</c:forEach>
			<tr>
